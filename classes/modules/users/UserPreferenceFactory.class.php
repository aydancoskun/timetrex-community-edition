		...
		switch ( $name ) {
			...
			case 'area_code_timezone':
				...
				$retval = [
						...
						807 => [ 'country' => 'CA', 'province' => 'ON', 'time_zone' => 'America/Toronto' ], ///-6	 Canada: W Ontario: Thunder Bay region to Manitoba border
						...
						867 => [ 'country' => 'CA', 'province' => 'YT', 'time_zone' => 'America/Whitehorse' ], ///-6/-7/-8	 Canada: Yukon, Northwest Territories, Nunavut (split from 403/819)
						709 => [ 'country' => 'CA', 'province' => 'NL', 'time_zone' => 'America/St_Johns' ], ///-3.5	 Canada: Newfoundland and Labrador
						...
						850 => [ 'country' => 'US', 'province' => 'FL', 'time_zone' => 'America/Chicago' ], ///-5	 Florida panhandle, from east of Tallahassee to Pensacola (split from 904); western panhandle (Pensacola, Panama City) are UTC-6
						...
						208 => [ 'country' => 'US', 'province' => 'ID', 'time_zone' => 'America/Denver' ], ///-8	 Idaho
						...
						219 => [ 'country' => 'US', 'province' => 'IN', 'time_zone' => 'America/Chicago' ], ///-5	 NW Indiana: Gary (see split 574, 260)
						...
						574 => [ 'country' => 'US', 'province' => 'IN', 'time_zone' => 'America/New_York' ], //	 N Indiana: Elkhart, South Bend (split from 219)
						765 => [ 'country' => 'US', 'province' => 'IN', 'time_zone' => 'America/New_York' ], //	 Indiana: outside Indianapolis (split from 317)
						812 => [ 'country' => 'US', 'province' => 'IN', 'time_zone' => 'America/Chicago' ], ///-5	 S Indiana: Evansville, Cincinnati outskirts in IN, Columbus, Bloomington (mostly GMT-5)
						316 => [ 'country' => 'US', 'province' => 'KS', 'time_zone' => 'America/Chicago' ], //	 S Kansas: Wichita (see split 620)
						620 => [ 'country' => 'US', 'province' => 'KS', 'time_zone' => 'America/Chicago' ], //	 S Kansas: Wichita (split from 316; perm 2/3/01)
						785 => [ 'country' => 'US', 'province' => 'KS', 'time_zone' => 'America/Chicago' ], //	 N & W Kansas: Topeka (split from 913)
						913 => [ 'country' => 'US', 'province' => 'KS', 'time_zone' => 'America/Chicago' ], //	 Kansas: Kansas City area (see 785)
						270 => [ 'country' => 'US', 'province' => 'KY', 'time_zone' => 'America/Chicago' ], //	 W Kentucky: Bowling Green, Paducah (split from 502)
						502 => [ 'country' => 'US', 'province' => 'KY', 'time_zone' => 'America/New_York' ], //	 N Central Kentucky: Louisville (see 270)
						606 => [ 'country' => 'US', 'province' => 'KY', 'time_zone' => 'America/New_York' ], ///-6	 E Kentucky: area east of Frankfort: Ashland (see 859)
						...
						906 => [ 'country' => 'US', 'province' => 'MI', 'time_zone' => 'America/Chicago' ], ///-5	 Upper Peninsula Michigan: Sault Ste. Marie, Escanaba, Marquette (UTC-6 towards the WI border)
						...
						701 => [ 'country' => 'US', 'province' => 'ND', 'time_zone' => 'America/Chicago' ], //	 North Dakota
						308 => [ 'country' => 'US', 'province' => 'NE', 'time_zone' => 'America/Chicago' ], ///-7	 W Nebraska: North Platte
						...
						541 => [ 'country' => 'US', 'province' => 'OR', 'time_zone' => 'America/Los_Angeles' ], ///-7	 Oregon: Eugene, Medford (split from 503; 503 retains NW part [Portland/Salem], all else moves to 541; eastern oregon is UTC-7)
						...
						605 => [ 'country' => 'US', 'province' => 'SD', 'time_zone' => 'America/Chicago' ], ///-7	 South Dakota
						423 => [ 'country' => 'US', 'province' => 'TN', 'time_zone' => 'America/New_York' ], //	 E Tennessee, except Knoxville metro area: Chattanooga, Bristol, Johnson City, Kingsport, Greeneville (see split 865; part of what used to be 615)
						...
						931 => [ 'country' => 'US', 'province' => 'TN', 'time_zone' => 'America/Chicago' ], //	 Middle Tennessee: semi-circular ring around Nashville (split from 615)
						...
						915 => [ 'country' => 'US', 'province' => 'TX', 'time_zone' => 'America/Denver' ], ///-6	 W Texas: El Paso (see splits 325 eff 4/5/03; 432, eff 4/5/03)
						...
						236 => [ 'country' => 'US', 'province' => 'VA', 'time_zone' => 'America/New_York' ], //	 Virginia (region unknown) / Unassigned?
