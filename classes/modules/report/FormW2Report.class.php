				...
				if ( isset( $this->form_data ) && count( $this->form_data ) > 0 ) {
					...
					foreach ( $user_rows as $user_id => $row ) {
						...
						if ( $ulf->getRecordCount() == 1 ) {
							...
							if ( $row['l12a'] > 0 && isset( $setup_data['l12a_code'] ) && $setup_data['l12a_code'] != '' ) {
								$ee_data['l12a_code'] = $setup_data['l12a_code'];
								$ee_data['l12a'] = $row['l12a'];
							}
							if ( $row['l12b'] > 0 && isset( $setup_data['l12b_code'] ) && $setup_data['l12b_code'] != '' ) {
								$ee_data['l12b_code'] = $setup_data['l12b_code'];
								$ee_data['l12b'] = $row['l12b'];
							}
							if ( $row['l12c'] > 0 && isset( $setup_data['l12c_code'] ) && $setup_data['l12c_code'] != '' ) {
								$ee_data['l12c_code'] = $setup_data['l12c_code'];
								$ee_data['l12c'] = $row['l12c'];
							}
							if ( $row['l12d'] > 0 && isset( $setup_data['l12d_code'] ) && $setup_data['l12d_code'] != '' ) {
							...
							if ( $row['l14a'] > 0 && isset( $setup_data['l14a_name'] ) && $setup_data['l14a_name'] != '' ) {
								$ee_data['l14a_name'] = $setup_data['l14a_name'];
								$ee_data['l14a'] = $row['l14a'];
							}
							if ( $row['l14b'] > 0 && isset( $setup_data['l14b_name'] ) && $setup_data['l14b_name'] != '' ) {
								$ee_data['l14b_name'] = $setup_data['l14b_name'];
								$ee_data['l14b'] = $row['l14b'];
							}
							if ( $row['l14c'] > 0 && isset( $setup_data['l14c_name'] ) && $setup_data['l14c_name'] != '' ) {
								$ee_data['l14c_name'] = $setup_data['l14c_name'];
								$ee_data['l14c'] = $row['l14c'];
							}
							if ( $row['l14d'] > 0 && isset( $setup_data['l14d_name'] ) && $setup_data['l14d_name'] != '' ) {
