...
//		return FALSE;
	...
	function Validate( $ignore_warning = true ) {
		...
		if ( $ignore_warning == false && $this->getDeleted() == false && $this->getStatus() == 10 && $this->getType() == 3000 && $this->getDataFormat() == 5 && is_object( $this->getLegalEntityObject() ) ) { //3000=EFT/ACH, 5=TimeTrex EFT
