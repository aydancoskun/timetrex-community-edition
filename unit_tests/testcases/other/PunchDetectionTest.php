...
class PunchDetectionTest extends PHPUnit_Framework_TestCase {
	...
	*/
	...
	function testNoMealOrBreakA() {
		...
		$dd->createPunch( $this->user_id, 10, 10, strtotime( $date_stamp . ' 8:00AM' ), [ 'branch_id' => 0, 'department_id' => 0, 'job_id' => 0, 'job_item_id' => 0 ], true );
	...
	function testNoMealOrBreakB() {
		...
		$dd->createPunch( $this->user_id, 10, 10, strtotime( $date_stamp . ' 8:00PM' ), [ 'branch_id' => 0, 'department_id' => 0, 'job_id' => 0, 'job_item_id' => 0 ], true );
	...
	function testNoMealOrBreakBWithFutureShiftA() {
		...
		$dd->createPunch( $this->user_id, 10, 10, strtotime( $date_stamp . ' 9:00PM' ), [ 'branch_id' => 0, 'department_id' => 0, 'job_id' => 0, 'job_item_id' => 0 ], true );
		$dd->createPunch( $this->user_id, 10, 20, strtotime( $date_stamp . ' 10:00PM' ), [ 'branch_id' => 0, 'department_id' => 0, 'job_id' => 0, 'job_item_id' => 0 ], true );
