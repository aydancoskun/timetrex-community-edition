WageViewController = BaseViewController.extend( {
	...
	buildEditViewUI: function() {
		...
		this.addEditFieldToColumn( $.i18n._( 'Wage' ), form_item_input, tab0_column1, '', widgetContainer );
		...
		this.addEditFieldToColumn( $.i18n._( 'Average Time / Week' ), form_item_input, tab0_column1, '', widgetContainer, true );
		...
		this.addEditFieldToColumn( $.i18n._( 'Annual Hourly Rate' ), form_item_input, tab0_column1, '', null, true );
		...
		this.addEditFieldToColumn( $.i18n._( 'Labor Burden Percent' ), form_item_input, tab0_column1, '', widgetContainer );
