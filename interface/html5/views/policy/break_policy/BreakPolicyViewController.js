BreakPolicyViewController = BaseViewController.extend( {
	...
	buildEditViewUI: function() {
		...
		tab_0_label.text( $.i18n._( 'Break Policy' ) );
...
//		  this.edit_view_tab.css( 'width', '700' );
		...
		widgetContainer.append( form_item_input );
		widgetContainer.append( label );
		this.addEditFieldToColumn( $.i18n._( 'Deduction/Addition Time' ), form_item_input, tab0_column1, '', widgetContainer, true );
		...
		this.addEditFieldToColumn( $.i18n._( 'Auto-Detect Breaks By' ), form_item_input, tab0_column1 );
		...
		widgetContainer.append( form_item_input );
		widgetContainer.append( label );
		this.addEditFieldToColumn( $.i18n._( 'Minimum Punch Time' ), form_item_input, tab0_column1, '', widgetContainer, true );
		...
		widgetContainer.append( form_item_input );
		widgetContainer.append( label );
		this.addEditFieldToColumn( $.i18n._( 'Maximum Punch Time' ), form_item_input, tab0_column1, '', widgetContainer, true );
		...
		widgetContainer.append( form_item_input );
		widgetContainer.append( label );
		this.addEditFieldToColumn( $.i18n._( 'Window Length' ), form_item_input, tab0_column1, '', widgetContainer, true );

		// Include Any Punched Time for Break
		form_item_input = Global.loadWidgetByName( FormItemType.CHECKBOX );
		form_item_input.TCheckbox( {field: 'include_break_punch_time'} );
		this.addEditFieldToColumn( $.i18n._( 'Include Any Punched Time for Break' ), form_item_input, tab0_column1, '', null, true );

		// Include Multiple Breaks
		form_item_input = Global.loadWidgetByName( FormItemType.CHECKBOX );
		form_item_input.TCheckbox( {field: 'include_multiple_breaks'} );
		this.addEditFieldToColumn( $.i18n._( 'Include Multiple Breaks' ), form_item_input, tab0_column1, '', null, true );
