EmployeeViewController = BaseViewController.extend( {
	...
	initDropDownOptions: function( options, callBack ) {
		...
		if ( this.hierarchyPermissionValidate() ) {
			...
			this.hierarchyControlAPI.getHierarchyControlOptions( {onResult: function( res ) {
				...
				$this.hierarchyControlAPI.getOptions( 'object_type', {onResult: function( res_1 ) {
	...
	onTabShow: function( e, ui ) {
		...
		if ( this.edit_view_tab_selected_index === 3 ) {
			...
			if ( this.current_edit_record.id ) {
				this.edit_view_tab.find( '#tab7' ).find( '.first-column-sub-view' ).css( 'display', 'block' );
				this.initSubLogView( 'tab7' );
			} else {
				this.edit_view_tab.find( '#tab7' ).find( '.first-column-sub-view' ).css( 'display', 'none' );
				this.edit_view.find( '.save-and-continue-div' ).css( 'display', 'block' );
			}
		} else {
	...
	initSubCompanyTaxView: function() {
		...
		Global.loadViewSource( 'CompanyTaxDeduction', 'CompanyTaxDeductionViewController.js', function() {
			var tab0 = $this.edit_view_tab.find( '#tab4' );
	...
	initSubUserContactView: function() {
		...
		Global.loadScriptAsync( 'views/employees/user_contact/UserContactViewController.js', function() {
			var tab0 = $this.edit_view_tab.find( '#tab5' );
			var firstColumn = tab0.find( '.first-column-sub-view' );
	...
	setJobItemValueWhenJobChanged: function( job ) {
		...
		var args = {};
		args.filter_data = {status_id: 10, job_id: $this.current_edit_record.default_job_id, company_id: $this.select_company_id};
	...
	setTabStatus: function() {
		...
		if ( this.is_mass_editing ) {
			...
			$( this.edit_view_tab.find( 'ul li' )[7] ).hide();
			...
			if ( this.subDocumentValidate() && this.select_company_id === LocalCacheData.getCurrentCompany().id ) {
				$( this.edit_view_tab.find( 'ul li' )[6] ).show();
			} else {
				$( this.edit_view_tab.find( 'ul li' )[6] ).hide();
				this.edit_view_tab.tabs( 'select', 0 );
			}
			if ( this.subAuditValidate() && this.select_company_id === LocalCacheData.getCurrentCompany().id ) {
				$( this.edit_view_tab.find( 'ul li' )[7] ).show();
			} else {
				$( this.edit_view_tab.find( 'ul li' )[7] ).hide();
				this.edit_view_tab.tabs( 'select', 0 );
			}
...
//		}
	...
	onAddClick: function() {
		...
		$this.api['get' + $this.api.key_name + 'DefaultData']( this.select_company_id, {onResult: function( result ) {
...
//					$this.grid.addRowData( new_record.id, new_record, 0 );
		...
		if ( filter && filter.filter_data && filter.filter_data.company_id ) {
			...
			this.user_group_api.getUserGroup( {filter_data: {company_id: this.select_company_id}}, false, false, {onResult: function( res ) {
	...
	buildEditViewUI: function() {
		...
		var tab_7_label = this.edit_view.find( 'a[ref=tab7]' );

		tab_0_label.text( $.i18n._( 'Employee' ) );
		tab_1_label.text( $.i18n._( 'Contact Info' ) );
		tab_2_label.text( $.i18n._( 'Hierarchy' ) );
		tab_3_label.text( $.i18n._( 'Wage' ) );
		tab_4_label.text( $.i18n._( 'Tax' ) );
		tab_5_label.text( $.i18n._( 'Contacts' ) );
		tab_6_label.text( $.i18n._( 'Attachment' ) );
		tab_7_label.text( $.i18n._( 'Audit' ) );
...
//		this.addEditFieldToColumn( $.i18n._( 'Company' ), form_item_input, tab0_column1, '' );
		...
		this.addEditFieldToColumn( $.i18n._( 'Password' ), form_item_input, tab0_column1 );
		...
		this.addEditFieldToColumn( $.i18n._( 'Confirm Password' ), form_item_input, tab0_column1 );
		...
		this.addEditFieldToColumn( $.i18n._( 'First Name' ), form_item_input, tab0_column2, '' );
		...
		this.addEditFieldToColumn( $.i18n._( 'Last Name' ), form_item_input, tab0_column2 );
		...
		this.addEditFieldToColumn( $.i18n._( 'Quick Punch ID' ), form_item_input, tab0_column2 );
		...
		this.addEditFieldToColumn( $.i18n._( 'Quick Punch Password' ), form_item_input, tab0_column2 );
		...
		this.addEditFieldToColumn( $.i18n._( 'Default Branch' ), form_item_input, tab0_column2 );
		...
		this.addEditFieldToColumn( $.i18n._( 'Default Department' ), form_item_input, tab0_column2 );
		...
		if ( ( LocalCacheData.getCurrentCompany().product_edition_id >= 20 ) ) {
			...
			this.addEditFieldToColumn( $.i18n._( 'Default Job' ), [form_item_input, job_coder], tab0_column2, '', widgetContainer, true );
			...
			widgetContainer.append( form_item_input );
			this.addEditFieldToColumn( $.i18n._( 'Default Task' ), [form_item_input, job_item_coder], tab0_column2, '', widgetContainer, true );
		...
		this.addEditFieldToColumn( $.i18n._( 'Group' ), form_item_input, tab0_column2 );
		...
		this.addEditFieldToColumn( $.i18n._( 'Ethnicity' ), form_item_input, tab0_column2 );

		//Hire Date
		form_item_input = Global.loadWidgetByName( FormItemType.DATE_PICKER );

		form_item_input.TDatePicker( {field: 'hire_date'} );
		this.addEditFieldToColumn( $.i18n._( 'Hire Date' ), form_item_input, tab0_column2 );

		//Termination Date
		form_item_input = Global.loadWidgetByName( FormItemType.DATE_PICKER );

		form_item_input.TDatePicker( {field: 'termination_date'} );
		this.addEditFieldToColumn( $.i18n._( 'Termination Date' ), form_item_input, tab0_column2 );
		...
		var tab1_column2 = tab1.find( '.second-column' );
		...
		if ( typeof FormData == "undefined" ) {
			...
			this.file_browser.bind( 'imageChange', function( e, target ) {
				new ServiceCaller().uploadFile( target.getValue(), 'object_type=user_photo&object_id=' + $this.current_edit_record.id, {onResult: function( result ) {
			...
			this.file_browser = form_item_input.TImageAdvBrowser( {field: '', default_width: 128, default_height: 128, callBack: function( form_data ) {
				new ServiceCaller().uploadFile( form_data, 'object_type=user_photo&object_id=' + $this.current_edit_record.id, {onResult: function( result ) {
		...
		this.addEditFieldToColumn( $.i18n._( 'Photo' ), this.file_browser, tab1_column1, '', null, false, true );

		//First Name
		form_item_input = Global.loadWidgetByName( FormItemType.TEXT_INPUT );
		form_item_input.TTextInput( {field: 'first_name_1', width: 200} );
		this.addEditFieldToColumn( $.i18n._( 'First Name' ), form_item_input, tab1_column1 );

		//Middle Name
		form_item_input = Global.loadWidgetByName( FormItemType.TEXT_INPUT );

		form_item_input.TTextInput( {field: 'middle_name', width: 200} );
		this.addEditFieldToColumn( $.i18n._( 'Middle Name' ), form_item_input, tab1_column1 );

		//Last Name
		form_item_input = Global.loadWidgetByName( FormItemType.TEXT_INPUT );

		form_item_input.TTextInput( {field: 'last_name_1', width: 200} );
		this.addEditFieldToColumn( $.i18n._( 'Last Name' ), form_item_input, tab1_column1 );
		...
		this.addEditFieldToColumn( $.i18n._( 'Gender' ), form_item_input, tab1_column1 );

		//Home Address(Line 1)
		form_item_input = Global.loadWidgetByName( FormItemType.TEXT_INPUT );

		form_item_input.TTextInput( {field: 'address1', width: 200} );
		this.addEditFieldToColumn( $.i18n._( 'Home Address(Line 1)' ), form_item_input, tab1_column1 );

		//Home Address(Line 2)
		form_item_input = Global.loadWidgetByName( FormItemType.TEXT_INPUT );

		form_item_input.TTextInput( {field: 'address2', width: 200} );
		this.addEditFieldToColumn( $.i18n._( 'Home Address(Line 2)' ), form_item_input, tab1_column1 );
		...
		this.addEditFieldToColumn( $.i18n._( 'Postal/ZIP Code' ), form_item_input, tab1_column1, '' );
		...
		this.addEditFieldToColumn( $.i18n._( 'Work Phone' ), form_item_input, tab1_column2, '' );
		...
		this.addEditFieldToColumn( $.i18n._( 'Work Phone Ext' ), form_item_input, tab1_column2 );

		//Home Phone
		form_item_input = Global.loadWidgetByName( FormItemType.TEXT_INPUT );

		form_item_input.TTextInput( {field: 'home_phone', width: 200} );
		this.addEditFieldToColumn( $.i18n._( 'Home Phone' ), form_item_input, tab1_column2 );

		//Mobile Phone
		form_item_input = Global.loadWidgetByName( FormItemType.TEXT_INPUT );

		form_item_input.TTextInput( {field: 'mobile_phone', width: 200} );
		this.addEditFieldToColumn( $.i18n._( 'Mobile Phone' ), form_item_input, tab1_column2 );
		...
		this.addEditFieldToColumn( $.i18n._( 'Fax' ), form_item_input, tab1_column2 );

		//Work Email
		form_item_input = Global.loadWidgetByName( FormItemType.TEXT_INPUT );

		form_item_input.TTextInput( {field: 'work_email', width: 200} );
		this.addEditFieldToColumn( $.i18n._( 'Work Email' ), form_item_input, tab1_column2 );

		//Fax
		form_item_input = Global.loadWidgetByName( FormItemType.TEXT_INPUT );

		form_item_input.TTextInput( {field: 'home_email', width: 200} );
		this.addEditFieldToColumn( $.i18n._( 'Home Email' ), form_item_input, tab1_column2 );

		//Birth Date
		form_item_input = Global.loadWidgetByName( FormItemType.DATE_PICKER );

		form_item_input.TDatePicker( {field: 'birth_date'} );
		this.addEditFieldToColumn( $.i18n._( 'Birth Date' ), form_item_input, tab1_column2 );

		//Sin
		form_item_input = Global.loadWidgetByName( FormItemType.TEXT_INPUT );

		form_item_input.TTextInput( {field: 'sin', width: 90} );
		this.addEditFieldToColumn( $.i18n._( 'SIN / SSN' ), form_item_input, tab1_column2 );
		...
		this.addEditFieldToColumn( $.i18n._( 'Note' ), form_item_input, tab1_column2, '', null, null, true );
		...
		if ( this.show_hierarchy ) {
			...
			for ( var i = 0; i < len; i++ ) {
				...
				if ( options ) {
					...
					this.addEditFieldToColumn( ui_model.value, form_item_input, tab2_column1 );
				}
			...
			form_item_input.TText( {field: ''} );
			form_item_input.setValue( $.i18n._( 'No Hierarchy List' ) );
			this.addEditFieldToColumn( '', form_item_input, tab2_column1 );
		}
	...
	buildSearchFields: function() {
		...
		var $this = this;
		this.search_fields = [
			new SearchField( {label: $.i18n._( 'Company' ),
				in_column: 1,
				field: 'company_id',
				layout_name: ALayoutIDs.COMPANY,
				api_class: (APIFactory.getAPIClass( 'APICompany' )),
			...
			new SearchField( {label: $.i18n._( 'Status' ),
				...
				form_item_type: FormItemType.AWESOME_BOX} ),
			new SearchField( {label: $.i18n._( 'First Name' ),
				in_column: 1,
				field: 'first_name',
				basic_search: true,
				adv_search: true,
				form_item_type: FormItemType.TEXT_INPUT} ),
			new SearchField( {label: $.i18n._( 'Last Name' ),
				field: 'last_name',
				basic_search: true,
				adv_search: true,
				in_column: 1,
				form_item_type: FormItemType.TEXT_INPUT} ),
			new SearchField( {label: $.i18n._( 'Home Phone' ),
				field: 'home_phone',
				basic_search: false,
				adv_search: true,
				in_column: 1,
			...
			new SearchField( {label: $.i18n._( 'Employee Number' ),
				field: 'employee_number',
				basic_search: false,
				adv_search: true,
				in_column: 2,
				form_item_type: FormItemType.TEXT_INPUT} ),
			new SearchField( {label: $.i18n._( 'Gender' ),
				in_column: 2,
				field: 'sex_id',
				multiple: true,
				basic_search: false,
			...
			new SearchField( {label: $.i18n._( 'City' ),
				...
				in_column: 3,
				form_item_type: FormItemType.TEXT_INPUT} ),
			new SearchField( {label: $.i18n._( 'SIN/SSN' ),
				field: 'sin',
				basic_search: false,
				adv_search: true,
				in_column: 3,
	...
	initSubDocumentView: function() {
		...
		Global.loadScriptAsync( 'views/document/DocumentViewController.js', function() {
			var tab1 = $this.edit_view_tab.find( '#tab6' );
